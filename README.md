...
📍 Apulia, Italy  
🌐 [rocco.me](https://rocco.me) • [GitHub](https://github.com/xdemocle)  
...
### Lead Software Engineer, Web3 — _The Web3 Ninja_ (2024–Present)
...
### Lead Frontend Engineer — _Games Global_ (2023–2024)
...
### Tech Lead, Web3 — _Shiba Inu_ (2023)
...
### Lead Frontend Engineer — _Ajna Labs_ (2022–2023)
...
### Lead Frontend Engineer — _Linum Labs_ (2021–2022)
...
### Lead Software Engineer, Web3 — _Omnia DeFi_ (2021)
...
### Lead Software Engineer — _HCLTech_ (2014–2015)
...
### Software Engineer — _Elsevier (Reaxys 2 Web App)_ (2013–2014)
...
### Software Engineer — _AdForum (Marketplace Advertising Industry)_ (2012–2013)
...
_More roles: 71web.ag, BetuniQ, SpiderSolutions.it — full list in `src/data/profile.json`._
...
- **Ajna Labs** — DeFi DApp + SDK ($20M liquidity) → [ajna.finance](https://www.ajna.finance)
- **Mode Network** — Large-scale React refactoring → [mode.network](https://www.mode.network)
- **CyberGrandpa Anti-Fraud** — Browser extension for phishing prevention → [source](https://github.com/CyberGrandpas/cybergrandpa-web-extension-antifraud)
- **Tetris with Crypto Rewards** — Telegram mini app with TON token prizes → [source](https://github.com/xdemocle/tetris-mini-app)
- **LinkedIn Full Width** — UI enhancement Chrome extension → [Chrome Store](https://chromewebstore.google.com/detail/linkedin-full-width/pijfcmadcbkcjdmajckndpccemdgebhn)
...
git clone https://github.com/xdemocle/my-linkedin-profile-clone.git
...
- [use-intl](https://use-intl.vercel.app/) for localization support.
