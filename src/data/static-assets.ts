...
export const staticAssets = {
  ...
  experienceLogos: {
    exp1: '/assets/png/web3ninja-logo.png',
    exp2: '/assets/png/gamesglobal-logo.png',
    exp3: '/assets/png/shibainu-logo.png',
    exp4: '/assets/png/ajna-logo.png',
    exp5: '/assets/png/linum-logo.png',
    exp6: '/assets/png/omnia-logo.png',
    exp7: '/assets/png/hcl-logo.png',
    exp8: '/assets/png/elsevier-logo.png',
    exp9: '/assets/png/adforum-logo.png',
  },
