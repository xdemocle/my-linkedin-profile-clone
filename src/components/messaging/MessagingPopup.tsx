  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: '2',
        sender: 'You',
        content: "Thank you, Giulia! I actually spent some time reviewing your portfolio as well. Great work on those UI designs!",
        timestamp: 'Yesterday',
        isSelf: true
      },
      {
...
export function MessagingPopup() {
  ...
  return (
    <div className="fixed bottom-0 right-6">
      {!isExpanded ? (
        <Button 
          className="rounded-t-lg rounded-b-none gap-2 h-12 px-6 shadow-md"
