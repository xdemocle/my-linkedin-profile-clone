...
const chats: Chat[] = [
  {
    ...
    messages: [
      ...
      },
      {
        ...
        sender: "Marco Bianchi",
        content:
          "All good here. Working on that project I told you about last week.",
        timestamp: "10:20 AM",
        isSelf: false,
      },
      {
        ...
        sender: "Marco Bianchi",
        content:
          "By the way, do you have time for a quick chat about the React component library?",
        timestamp: "10:21 AM",
        isSelf: false,
      },
      {
    ...
    messages: [
      {
        ...
        content:
          "Hello Rocco! I just looked at your LinkedIn profile. Very impressive!",
        timestamp: "Yesterday",
        isSelf: false,
      },
      {
...
export function MessagingPopup() {
  ...
  return (
    <div className="fixed bottom-0 right-6">
      {!isExpanded ? (
        <Button
          className="rounded-t-lg rounded-b-none gap-2 h-12 px-6 shadow-xs"
