  ...
  return (
    <Card className="mx-auto max-w-md mt-8 shadow-xs">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Something went wrong while loading this section. This might be a translation error or data loading issue.
        </CardDescription>
      </CardHeader>
        ...
        <Card className="mx-auto max-w-md mt-4 shadow-xs">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Translation not available. Please try switching languages or refreshing the page.
            </p>
          </CardContent>
        </Card>
      }
